(function () {
    ...
    var messages = {
        en: {
            ...
            "aria.socialLinks": "Helio Med social links",
            "aria.facebook": "Helio Med on Facebook",
            "aria.linkedin": "Helio Med on LinkedIn",
            "aria.instagram": "Helio Med on Instagram",
            "aria.whatsapp": "Contact Helio Med on WhatsApp",
            ...
            "loader.label": "Loading Helio Med storefront",
            "loader.title": "Preparing Helio Med",
            "loader.copy": "Loading care picks, categories, and featured products...",
            "hero.kicker": "Helio Med Essentials",
            "hero.title": "Care You Can Trust at Home",
            "hero.copy": "Daily Parapharmacy, beauty, wellness, and recovery essentials organized for fast decisions.",
            ...
            "footer.care": "Helio Med Care",
            "footer.careCopy": "Parapharmacy & healthcare store serving all regions of Lebanon with authentic products.",
            "footer.whatsapp": "Direct WhatsApp",
            "footer.whatsappCta": "Connect with our specialists →",
            "footer.logoSub": "trusted Parapharmacy care",
            "footer.rights": "All Rights Reserved © 2026 Helio Med",
            "trust.shippingTitle": "Fast Nationwide Delivery",
            "trust.shippingDesc": "Reliable delivery across all Lebanon",
            "trust.authenticTitle": "100% Genuine Products",
            "trust.authenticDesc": "Sourced from certified distributors",
            "trust.wellnessTitle": "Health & Wellness",
            "trust.wellnessDesc": "Care curated for your daily vitality",
            "trust.supportTitle": "Dedicated Customer Care",
            "trust.supportDesc": "Mon–Sat 9AM–6PM on WhatsApp",
            "footer.brandBio": "Lebanon's trusted parapharmacy and healthcare destination. Delivering authentic medical supplies, supplements, and skin wellness essentials to your doorstep.",
            "footer.shopHeading": "Shop",
            "footer.parapharmacy": "Parapharmacy",
            "footer.supplements": "Supplements",
            "footer.beautyPersonalCare": "Beauty & Personal Care",
            "footer.organic": "Organic",
            "footer.perfumeMakeup": "Perfume & Makeup",
            "footer.careHeading": "Customer Care",
            "footer.contact": "Contact Us",
            "footer.shipping": "Shipping & Delivery",
            "footer.returns": "Returns & Refunds",
            "footer.faq": "Frequently Asked Questions",
            "footer.companyHeading": "Company & Legal",
            "footer.about": "About HELIO MED",
            "footer.privacy": "Privacy Policy",
            "footer.terms": "Terms & Conditions",
            "footer.shippingPolicy": "Shipping Policy",
            "footer.returnsPolicy": "Return & Refund Policy",
            "footer.officialHeading": "Official Company Information",
            "footer.officialName": "HELIO MED",
            "footer.officialDesc": "Registered healthcare and trading company in Lebanon",
            "footer.serviceArea": "Lebanon (Nationwide Dispatch)",
            "footer.emailLabel": "Email:",
            "footer.whatsappLabel": "WhatsApp:",
            "footer.disclaimerLabel": "Health Disclaimer:",
            "footer.disclaimerText": "Product and health information provided on this website is for general informational purposes only and does not replace professional medical advice, diagnosis, or treatment. Product images, packaging, ingredients, and specifications may change without prior notice from the manufacturer.",
            "footer.rightsText": "All Rights Reserved © 2026 HELIO MED.",
            "care.breadcrumbHome": "Home",
            "care.breadcrumbCare": "Customer Care & Legal",
            "care.navAbout": "About Us",
            "care.navContact": "Contact Us",
            "care.navShipping": "Shipping & Delivery",
            "care.navReturns": "Returns & Refunds",
            "care.navTrack": "Track Order",
            "care.navFaq": "FAQ",
            "care.navPrivacy": "Privacy Policy",
            "care.navTerms": "Terms & Conditions",
            "collection.home": "Home",
            "collection.label": "Collection",
            "collection.copy": "Browse Helio Med products.",
            ...
            "product.defaultDescription": "{title} from {brand}, selected for Helio Med care routines.",
            ...
            "brand.featuredCopy": "Discover popular names selected by Helio Med.",
        ...
        ar: {
            ...
            "trust.shippingTitle": "توصيل سريع لكافة المناطق",
            "trust.shippingDesc": "توصيل موثوق لجميع أنحاء لبنان",
            "trust.authenticTitle": "منتجات أصلية 100%",
            "trust.authenticDesc": "من الموردين والوكلاء المعتمدين",
            "trust.wellnessTitle": "صحة وعافية",
            "trust.wellnessDesc": "عناية مختارة لحياتك اليومية",
            "trust.supportTitle": "خدمة عملاء متخصصة",
            "trust.supportDesc": "من الإثنين للسبت 9ص–6م عبر واتساب",
            "footer.brandBio": "وجهتكم الموثوقة للبارافارماسي والرعاية الصحية في لبنان. نؤمن المستلزمات الطبية الأصلية، المكملات الغذائية، ومنتجات العناية بالبشرة حتى باب منزلكم.",
            "footer.shopHeading": "التسوق",
            "footer.parapharmacy": "بارافارماسي",
            "footer.supplements": "المكملات الغذائية",
            "footer.beautyPersonalCare": "الجمال والعناية الشخصية",
            "footer.organic": "منتجات عضوية",
            "footer.perfumeMakeup": "العطور والمكياج",
            "footer.careHeading": "خدمة العملاء",
            "footer.contact": "اتصل بنا",
            "footer.shipping": "الشحن والتوصيل",
            "footer.returns": "الاستبدال والاسترجاع",
            "footer.faq": "الأسئلة الشائعة",
            "footer.companyHeading": "الشركة والشؤون القانونية",
            "footer.about": "عن HELIO MED",
            "footer.privacy": "سياسة الخصوصية",
            "footer.terms": "الشروط والأحكام",
            "footer.shippingPolicy": "سياسة الشحن والتوصيل",
            "footer.returnsPolicy": "سياسة الاسترجاع والاسترداد",
            "footer.officialHeading": "المعلومات الرسمية للشركة",
            "footer.officialName": "HELIO MED",
            "footer.officialDesc": "شركة مسجلة للرعاية الصحية والتجارة في لبنان",
            "footer.serviceArea": "لبنان (توصيل لكافة الأراضي اللبنانية)",
            "footer.emailLabel": "البريد الإلكتروني:",
            "footer.whatsappLabel": "واتساب:",
            "footer.disclaimerLabel": "إخلاء مسؤولية طبية:",
            "footer.disclaimerText": "المعلومات الصحية والمنتجات المعروضة على هذا الموقع مخصصة لأغراض إعلامية وتثقيفية عامة فقط، ولا تشكل بأي شكل من الأشكال بديلاً عن الاستشارة الطبية المتخصصة أو التشخيص الطبي. قد تخضع صور المنتجات، وتغليفها، ومكوناتها لتحديثات مستمرة من الشركات المصنعة دون إشعار مسبق.",
            "footer.rightsText": "جميع الحقوق محفوظة © 2026 HELIO MED.",
            "care.breadcrumbHome": "الرئيسية",
            "care.breadcrumbCare": "خدمة العملاء والمعلومات القانونية",
            "care.navAbout": "من نحن",
            "care.navContact": "اتصل بنا",
            "care.navShipping": "الشحن والتوصيل",
            "care.navReturns": "الاسترجاع والاستبدال",
            "care.navTrack": "تتبع الطلب",
            "care.navFaq": "الأسئلة الشائعة",
            "care.navPrivacy": "سياسة الخصوصية",
            "care.navTerms": "الشروط والأحكام",
    ...
    var textAliases = {
        ...
        "Helio Med Essentials": "hero.kicker",
        "Care You Can Trust at Home": "hero.title",
        "Daily Parapharmacy, beauty, wellness, and recovery essentials organized for fast decisions.": "hero.copy",
        ...
        "Helio Med Care": "footer.care",
        "Parapharmacy & healthcare store serving all regions of Lebanon with authentic products.": "footer.careCopy",
        "Direct WhatsApp": "footer.whatsapp",
        "Connect with our specialists →": "footer.whatsappCta",
        "trusted Parapharmacy care": "footer.logoSub",
        "All Rights Reserved © 2026 Helio Med": "footer.rights",
    ...
    var attrAliases = {
        ...
        "Contact Helio Med on WhatsApp": "aria.whatsapp",
